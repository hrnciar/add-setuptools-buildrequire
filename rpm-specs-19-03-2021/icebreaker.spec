...
- fixes to the Windows build make this version 2.2

* Mon Mar  1 2021 Matthew Miller <mattdm@mattdm.org> - 2.1.3-1
- fix metainfo oops

* Mon Mar  1 2021 Matthew Miller <mattdm@mattdm.org> - 2.1.2-1
- include metainfo for GNOME Software

* Tue Feb 23 2021 Matthew Miller <mattdm@mattdm.org> - 2.1.1-2
- gratuitous bump to fix changelog order
