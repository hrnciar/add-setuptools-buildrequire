...
%changelog
* Tue Jan 26 2021 Fedora Release Engineering <releng@fedoraproject.org> - 1:3.3.2-8
- Rebuilt for https://fedoraproject.org/wiki/Fedora_34_Mass_Rebuild

* Thu Oct 22 2020 Evan Klitzke <evan@eklitzke.org> - 1:3.3.2-7
- Build using -DGLFW_USE_WAYLAND=ON
