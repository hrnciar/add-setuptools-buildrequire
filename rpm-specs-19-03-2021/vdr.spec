...
# Patch APIVERSION TO 2.4.6 to match VDRVERSION
sed -i 's/2\.4\.3/2.4.6/' config.h
sed -i 's/20403/20406/' config.h
...
make vdr.pc BINDIR=%{_bindir} MANDIR=%{_mandir} CONFDIR=%{configdir} \
    ...
    CXXFLAGS="$cflags -Werror=overloaded-virtual -Wno-parentheses -std=gnu++14"
...
%changelog
* Tue Mar 02 2021 Zbigniew Jędrzejewski-Szmek <zbyszek@in.waw.pl> - 2.4.6-8
