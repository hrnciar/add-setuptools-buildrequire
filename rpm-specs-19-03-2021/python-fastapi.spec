...
# https://bugzilla.redhat.com/show_bug.cgi?id=1936021 is fixed.
sed -r -i \
    -e 's/("orjson\b.*",)/# \1/' \
    -e 's/==/>=/g' \
...
# We can restore this functionality after it is packaged separately:
# https://bugzilla.redhat.com/show_bug.cgi?id=1935984
