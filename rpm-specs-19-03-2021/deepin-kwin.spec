...
# build fix
# Author: Robin Lee <cheeselee@fedoraproject.org>
Patch0003: 0003-build-fix.patch

# unload blur
# Author: Robin Lee <cheeselee@fedoraproject.org>
Patch0004: 0004-unload-blur.patch

# qt5.15 fix
# Author: Robin Lee <cheeselee@fedoraproject.org>
Patch0005: 0005-qt5.15-fix.patch
...
ln -sf kwin_x11 %{buildroot}%{_bindir}/kwin_no_scale
%else
%cmake_install
