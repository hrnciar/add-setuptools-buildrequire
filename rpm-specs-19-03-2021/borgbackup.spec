...
# Python 3.10 dropped the old buffer protocol and the vendored msgpack was not
# updated yet so we need to backport the relevant msgpack upstream commit.
Patch3:         borgbackup-msgpack-drop-old-buffer-protocol.patch
