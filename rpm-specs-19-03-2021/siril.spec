...
Patch0:         siril-0.99.8-gcc11.patch
Patch1:         siril-0.99.8-opencv_flann.patch
# Backport upstream patch to fix new templating in gcc11
Patch2:         siril-0.99.8-glibc.patch
...
Provides:       bundled(librtprocess) = 0.11.0
...
* Wed Jan 27 2021 Fedora Release Engineering <releng@fedoraproject.org> - 0.99.6-3
