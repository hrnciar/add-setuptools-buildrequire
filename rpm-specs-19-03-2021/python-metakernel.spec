...
pid=$!
%if %{fedora} >= 34
# The REPLWrapTestCase.test_python test fails with readline version 8.1
# https://github.com/Calysto/metakernel/issues/228
pytest-3 -v metakernel -k 'not REPLWrapTestCase or not test_python'
%else
