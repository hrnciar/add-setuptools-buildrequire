...
Source1: https://www.dns-oarc.net/files/dnsperf/data/queryfile-example-10million-%{dataversion}.gz

Patch1: dnsperf-nolicense.patch
# https://github.com/DNS-OARC/dnsperf/pull/125
Patch2: dnsperf-2.4-queryparse-sort-list.patch
Patch3: dnsperf-2.4-queryparse-interrupt.patch
...
BuildArch: noarch
Version: %{dataversion}
# Just for license file, any version containing the same license is ok
# Cannot use %%version-%%release, because %%version is local for data
Requires: %{name} >= 2.4.0
