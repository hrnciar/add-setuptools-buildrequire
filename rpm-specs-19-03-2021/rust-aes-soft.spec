...
This package contains library source intended for building other packages
which use "semi_fixslice" feature of "%{crate}" crate.
...
* Wed Dec 02 2020 Fabio Valentini <decathorpe@gmail.com> - 0.6.4-1
- Update to version 0.6.4.
- Fixes RHBZ#1867241

* Mon Nov 16 2020 Fabio Valentini <decathorpe@gmail.com> - 0.6.3-1
