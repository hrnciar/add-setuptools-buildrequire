...
%global github_commit   91baf79349a1310c8145e4b24169bca6881d55b7
# if set, will be a post-release snapshot build, otherwise a 'normal' build
%global github_date     20201103
...
Release:        61%{?github_date:.%{github_date}git%{shortcommit}}%{?dist}
...
# Fix create_admin script to not *always* fail
# https://github.com/os-autoinst/openQA/pull/3519
Patch0:         0001-Fix-create_admin-by-not-expecting-ARGV-after-parsing.patch
# Fix placeholder substitution and overrides for _URL-derived settings
# https://github.com/os-autoinst/openQA/pull/3564
Patch1:         0001-Handle-placeholders-after-parsing-_URL-settings.patch
Patch2:         0002-Don-t-set-FOO-from-FOO_URL-if-FOO-is-defined-but-fal.patch
Patch3:         0003-parse_url_settings-improve-filename-parse-check.patch
Patch4:         0004-parse_url_settings-don-t-parse-value-for-non-asset-t.patch
