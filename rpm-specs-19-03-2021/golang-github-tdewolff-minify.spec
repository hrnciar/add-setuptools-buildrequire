...
BuildRequires:  (golang(github.com/tdewolff/parse/v2)         >= 2.5.14 with golang(github.com/tdewolff/parse/v2)         < 3)
BuildRequires:  (golang(github.com/tdewolff/parse/v2/buffer)  >= 2.5.14 with golang(github.com/tdewolff/parse/v2/buffer)  < 3)
BuildRequires:  (golang(github.com/tdewolff/parse/v2/css)     >= 2.5.14 with golang(github.com/tdewolff/parse/v2/css)     < 3)
BuildRequires:  (golang(github.com/tdewolff/parse/v2/html)    >= 2.5.14 with golang(github.com/tdewolff/parse/v2/html)    < 3)
BuildRequires:  (golang(github.com/tdewolff/parse/v2/js)      >= 2.5.14 with golang(github.com/tdewolff/parse/v2/js)      < 3)
BuildRequires:  (golang(github.com/tdewolff/parse/v2/json)    >= 2.5.14 with golang(github.com/tdewolff/parse/v2/json)    < 3)
BuildRequires:  (golang(github.com/tdewolff/parse/v2/strconv) >= 2.5.14 with golang(github.com/tdewolff/parse/v2/strconv) < 3)
BuildRequires:  (golang(github.com/tdewolff/parse/v2/xml)     >= 2.5.14 with golang(github.com/tdewolff/parse/v2/xml)     < 3)
...
* Fri Jan 22 14:41:52 CET 2021 Robert-André Mauchin <zebob.m@gmail.com> - 2.9.11-1
- Update to 2.9.11
- Close: rhbz#1918451
