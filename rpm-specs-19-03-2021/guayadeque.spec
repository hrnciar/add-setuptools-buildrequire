# https://github.com/anonbeat/guayadeque/commit/46cd022d3443a5c93646cb50d710a187adb499b7
%global commit0 46cd022d3443a5c93646cb50d710a187adb499b7
%global shortcommit0 %(c=%{commit0}; echo ${c:0:7})
%global gitdate 20210309

Name:           guayadeque
Version:        0.4.7
Release:        0.26.%{gitdate}git%{shortcommit0}%{?dist}
