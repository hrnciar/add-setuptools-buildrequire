...
MINGW_BUILDDIR_SUFFIX=py3 %mingw_make_build


%install
MINGW_BUILDDIR_SUFFIX=py3 %mingw_make_install
...
%changelog
* Tue Jan 26 2021 Fedora Release Engineering <releng@fedoraproject.org> - 1.51-2
