...
#
%global bootstrap    0
%global gh_commit    37c5f5ac9240159f5d93f52367d0e57fa96f9b22
...
BuildRequires: (php-autoloader(%{gh_owner}/laminas-hydrator)             >= 3       with php-autoloader(%{gh_owner}/laminas-hydrator)             < 4)
