...
%package     -n %{name}+quickcheck09-devel
Summary:        %{summary}
BuildArch:      noarch

%description -n %{name}+quickcheck09-devel %{_description}

This package contains library source intended for building other packages
which use "quickcheck09" feature of "%{crate}" crate.

%files       -n %{name}+quickcheck09-devel
%ghost %{cargo_registry}/%{crate}-%{version_no_tilde}/Cargo.toml
