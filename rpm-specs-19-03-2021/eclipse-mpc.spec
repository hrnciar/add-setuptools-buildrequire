%global mpc_repo_tag aee85ff560ec72f19e38de0ecde714728e294671
...
# update BREE in userstorage
sed -i -e 's/JavaSE-1.6/JavaSE-1.8/g' org.eclipse.userstorage/META-INF/MANIFEST.MF
sed -i -e 's/JavaSE-1.6/JavaSE-1.8/g' org.eclipse.userstorage.oauth/META-INF/MANIFEST.MF
...
%changelog
* Wed Mar 10 2021 Mat Booth <mat.booth@redhat.com> - 1.9.1-1
- Update to latest upstream release

* Tue Jan 26 2021 Fedora Release Engineering <releng@fedoraproject.org> - 1.9.0-2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_34_Mass_Rebuild

* Fri Jan 15 2021 Alexander Kurtakov <akurtako@redhat.com> 1.9.0-1
- Update to latest upstream release.

* Fri Oct 30 2020 Mat Booth <mat.booth@redhat.com> - 1.8.4-1
- Update to latest upstream release
