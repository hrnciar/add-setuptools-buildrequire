...
#LANG=en_US.UTF-8 XDG_RUNTIME_DIR=/tmp/zim-$USER HOME=/tmp/home-$USER xvfb-run ./test.py
...
%changelog
* Mon Feb  1 2021 Robin Lee <cheeselee@fedoraproject.org> - 0.73.5-1
- Update to 0.73.5

* Mon Jan 25 2021 Fedora Release Engineering <releng@fedoraproject.org> - 0.73.4-2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_34_Mass_Rebuild

* Sat Nov 21 2020 Robin Lee <cheeselee@fedoraproject.org> - 0.73.4-1
- Update to 0.73.4
