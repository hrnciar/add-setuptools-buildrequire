...
# cd rake && git archive -v -o rake-13.0.3-tests.txz v13.0.3 test
...
# 13.0.3 TestRakeFunctional#test_signal_propagation_in_tests does not pass..
sed -i test/test_rake_functional.rb \
	-e '\@jruby@s@\(can_detect_signals.\)@\1 \&\& false@'
