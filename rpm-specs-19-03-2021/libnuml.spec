...
Patch1: %{name}-porting_to_python310.patch

# workaround for doxygen crash, it should be removed once it's fixed in doxygen
Patch2: libnuml-doxygen-1.9.1-workaround-crash.patch
...
%patch2 -p1 -b .doxygen-workaround
