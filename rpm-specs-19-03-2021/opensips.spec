...
Patch007: opensips-0007-tm-clone-message-in-async-mode-only-in-request-route.patch
%if 0%{?fedora} >= 34
Patch008: opensips-0008-libcouchbase-API-v3.patch
%endif
Patch009: opensips-0009-tm-Fix-t_on_branch-PKG-memory-leak.patch
Patch010: opensips-0010-tm-Be-more-verbose-when-async-detected-in-non-reques.patch
Patch011: opensips-0011-async-Report-an-error-when-using-timeouts-incorrectl.patch
