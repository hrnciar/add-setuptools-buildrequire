...
# git archive -v -o rspec-rails-4.0.2-tests.tar.gz v4.0.2 features/ spec/
Source1: %{gem_name}-%{version}-tests.tar.gz
# Fix view specs on Rails 6.1.
# https://github.com/rspec/rspec-rails/pull/2398/commits/62b835038a3cda02e890db8abce13b4077206dad
Patch0: rubygem-rspec-rails-4.0.2-Fix-view-specs-on-Rails-6.1.patch
# Switch accessor for fixture path in file upload support for 6.1.
# https://github.com/rspec/rspec-rails/pull/2398/commits/3e07b342ed820236643d267442a09eb083a99ed6
Patch1: rubygem-rspec-rails-4.0.2-Switch-accessor-for-fixture-path-in-file-upload-support-for-6.1.patch
Patch2: rubygem-rspec-rails-4.0.2-Switch-accessor-for-fixture-path-in-file-upload-support-for-6.1-test.patch
