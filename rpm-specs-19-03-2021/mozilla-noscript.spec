...
Source0:        https://addons.mozilla.org/firefox/downloads/file/%{fileid}/noscript_security_suite-%{version}-an+fx.xpi
...
Provides:       bundled(webextension-polyfill) = 0.7.0
