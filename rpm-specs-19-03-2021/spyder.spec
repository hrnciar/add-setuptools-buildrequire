...
sed -i 's/\xe2\x80\x8b//g' scripts/%{name}.appdata.xml
...
install -m 0644 scripts/spyder.appdata.xml %{buildroot}/%{_datadir}/appdata/
...
* Thu Dec 24 2020 Mukundan Ragavan <nonamedotc@fedoraproject.org> - 4.2.1-1
- Update to 4.2.1
