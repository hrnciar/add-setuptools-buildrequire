...
install -pm0644 awesome-%{name}-%{awe_commit}/distro-logos/fedora/icewm.png %{buildroot}%{_datadir}/%{name}/themes/IceAdwaita-Small/taskbar/icewm.png
install -pm0644 awesome-%{name}-%{awe_commit}/distro-logos/fedora/icewm-24.png %{buildroot}%{_datadir}/%{name}/themes/IceAdwaita-Medium/taskbar/icewm.png
install -pm0644 awesome-%{name}-%{awe_commit}/distro-logos/fedora/icewm-24.png %{buildroot}%{_datadir}/%{name}/themes/IceAdwaita-Dark-Medium-alpha/taskbar/icewm.png
install -pm0644 awesome-%{name}-%{awe_commit}/distro-logos/fedora/icewm-32.png %{buildroot}%{_datadir}/%{name}/themes/IceAdwaita-Large/taskbar/icewm.png
