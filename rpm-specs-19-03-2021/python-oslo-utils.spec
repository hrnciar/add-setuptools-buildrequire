...
%if 0%{?with_doc}
# generate html docs
# Disable warning-is-error in fedora as it fails to load python-dns because
# /etc/resolv.conf does not exist in fedora buildroot
...
%check
# disable unit tests as python-dns can not be loaded in fedora buildroot because
