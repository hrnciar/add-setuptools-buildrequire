...
%changelog
* Wed Mar 10 2021 Davide Cavalca <dcavalca@fedoraproject.org> - 0.1.0-3
- Gate cli11-static to Fedora as it's not available in EPEL

* Tue Mar  9 2021 Davide Cavalca <dcavalca@fedoraproject.org> - 0.1.0-2
- Rename to flopgen
- Fix license
- Add BuildRequires on cli11-static

* Sun Jan  3 2021 Davide Cavalca <dcavalca@fedoraproject.org> - 0.1.0-1
- Initial package
