...
# Python 3.10 removes deprecated aliases to Collections Abstract Base Classes
# from the collections module. This patch fixes ImportError until it's fixed in
# upstream.
# https://github.com/astanin/python-tabulate/issues/104
Patch1:         0001-python3.10-fix-ImportError.patch
