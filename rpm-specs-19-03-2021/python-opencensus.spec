...
%py_provides python3-%{srcname}-context
...
%py_provides python3-%{srcname}-correlation
...
%py_provides python3-%{srcname}-ext-azure
...
%py_provides python3-%{srcname}-ext-gevent
...
# %%py_provides python3-%%{srcname}-ext-google-cloud-clientlibs
...
%py_provides python3-%{srcname}-ext-httplib
...
%py_provides python3-%{srcname}-ext-logging
...
%py_provides python3-%{srcname}-ext-ocagent
...
%py_provides python3-%{srcname}-ext-postgresql
...
%py_provides python3-%{srcname}-ext-pyramid
...
# %%py_provides python3-%%{srcname}-ext-stackdriver
...
%py_provides python3-%{srcname}-ext-threading
...
%check
# Disable tests requiring online connection
...
%changelog
* Sat Feb 13 2021 Mohamed El Morabity <melmorabity@fedoraproject.org> - 0.7.12-1
- Update to 0.7.12

* Wed Jan 27 2021 Fedora Release Engineering <releng@fedoraproject.org> - 0.7.11-2
...
* Thu Jul 02 2020 Mohamed El Morabity <melmorabity@fedoraproject.org> - 0.7.10-1
- Update to 0.7.10
