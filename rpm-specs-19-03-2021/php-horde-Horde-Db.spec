...
# Optional
Recommends:    (php-pear(%{pear_channel}/Horde_Autoloader)  >= 2.0.0  with php-pear(%{pear_channel}/Horde_Autoloader)  < 3)
...
%changelog
* Wed Feb 24 2021 Remi Collet <remi@remirepo.net> - 2.4.1-1
- update to 2.4.1
