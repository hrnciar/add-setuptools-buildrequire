...
Provides: bundled(golang(github.com/coreos/ignition/v2/config/merge)) = 2.8.1
Provides: bundled(golang(github.com/coreos/ignition/v2/config/shared/errors)) = 2.8.1
Provides: bundled(golang(github.com/coreos/ignition/v2/config/shared/validations)) = 2.8.1
Provides: bundled(golang(github.com/coreos/ignition/v2/config/util)) = 2.8.1
Provides: bundled(golang(github.com/coreos/ignition/v2/config/v3_0/types)) = 2.8.1
Provides: bundled(golang(github.com/coreos/ignition/v2/config/v3_1/types)) = 2.8.1
Provides: bundled(golang(github.com/coreos/ignition/v2/config/v3_2/types)) = 2.8.1
Provides: bundled(golang(github.com/coreos/ignition/v2/config/v3_3_experimental/types)) = 2.8.1
Provides: bundled(golang(github.com/coreos/ignition/v2/config/validate)) = 2.8.1
...
%changelog
* Mon Feb 01 2021 Benjamin Gilbert <bgilbert@redhat.com> - 0.10.0-1
- New release

* Tue Jan 26 2021 Fedora Release Engineering <releng@fedoraproject.org> - 0.9.0-2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_34_Mass_Rebuild

* Wed Jan 06 2021 Sohan Kunkerkar <skunkerk@redhat.com> - 0.9.0-1
- New release

* Fri Dec 04 2020 Sohan Kunkerkar <skunkerk@redhat.com> - 0.8.0-1
- New release
