...
Version:    27
#Release:    XX%%{?dist}.%%{commit_date}.%%{commit_short}
Release:    4%{?dist}
...
Requires: gnome-shell >= 3.34, gnome-shell < 3.39
...
* Fri May 01 2020 Audrey Toskin <audrey@tosk.in> - 27-1
- Bump to upstream version 27.

* Wed Apr 15 2020 Audrey Toskin <audrey@tosk.in> - 22-8.20200414.bfa3fe3
