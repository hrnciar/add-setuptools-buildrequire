...
BuildRequires:    R-devel >= 3.2.0, texlive-latex, R-methods, R-GenomicRanges >= 1.41.5, R-Biobase
BuildRequires:    R-DelayedArray >= 0.15.10, R-utils, R-stats, R-tools, R-Matrix, R-BiocGenerics >= 0.15.3
