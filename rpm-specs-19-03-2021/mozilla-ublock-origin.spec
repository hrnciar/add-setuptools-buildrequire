...
%global uAssets_commit f3dac523af291e1e109ffdce234c554f48f57564
...
License:        GPLv3+ and LGPLv3 and MIT and OFL and Unlicense
...
Provides:       bundled(js-codemirror) = 5.59.0
...
Provides:       bundled(publicsuffix-list) = 20201229
...
%license uBlock-%{version}/LICENSE.fontawesome.txt
%license uBlock-%{version}/LICENSE.Inter.txt
%license uBlock-%{version}/src/css/fonts/Metropolis/UNLICENSE
