...
%py_byte_compile %{python3} %{buildroot}/%{sugaractivitydir}/Measure.activity/
...
%changelog
* Sun Feb 14 2021 Ibiam Chihurumnaya <ibiamchihurummnaya@gmail.com> - 103-5
- fix py byte compile

* Wed Jan 27 2021 Fedora Release Engineering <releng@fedoraproject.org> - 103-4
