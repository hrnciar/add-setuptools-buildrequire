...
# git archive -v -o web-console-4.1.0-tests.tar.gz v4.1.0 test/
Source1: %{gem_name}-%{version}-tests.tar.gz
# Fix Ruby 3.0 compatibility.
# https://github.com/rails/web-console/pull/306
Patch0: rubygem-web-console-4.1.0-Make-binding.eval-Ruby-3.0-compatible.patch
