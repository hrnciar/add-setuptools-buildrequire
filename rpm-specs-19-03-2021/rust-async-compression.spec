...
# * drop tokio 0.3 support (we skipped 0.3 and went from 0.2 to 1.0 directly)
Patch0:         async-compression-fix-metadata.diff
...
This package contains library source intended for building other packages
which use "bytes-05" feature of "%{crate}" crate.
