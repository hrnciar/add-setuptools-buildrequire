...
%global subpkgs %{indexedprofunctors} %{opticscore} %{these} %{semialign} %{topograph} %{cabalplan}
...
Source7:        https://hackage.haskell.org/package/%{pkgver}/%{pkg_name}.cabal#/%{pkgver}.cabal
