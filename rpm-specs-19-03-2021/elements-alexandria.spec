...
# Test assumes little endian
# Fixed on next version
Patch0:         elements-alexandria_bigendian_test.patch
# Fix an padding issue that causes a bad alignment signal on armv7
Patch1:         elements-alexandria_ndarray_align.patch

%global elements_version 5.12
