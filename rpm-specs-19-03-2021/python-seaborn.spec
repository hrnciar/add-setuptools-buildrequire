...
BuildRequires: python3-numpy >= 1.15 
BuildRequires: python3-scipy >= 1.0
BuildRequires: python3-matplotlib >= 2.2
BuildRequires: python3-pandas >= 0.23
BuildRequires: python3-husl python3-numpydoc
BuildRequires: python3-pytest python3-nose

Requires: python3-husl
Requires: python3-numpydoc
Recommends: python3-pytest python3-nose
