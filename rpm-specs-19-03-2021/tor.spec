...
Source2:    tor-keyring.pub
Source3:    tor.logrotate
Source4:    tor.defaults-torrc
Source5:    tor.tmpfiles.d
...
install -D -p -m 0644 %{SOURCE3}  %{buildroot}%{_sysconfdir}/logrotate.d/tor
install -D -p -m 0644 %{SOURCE4}  %{buildroot}%{_datadir}/tor/defaults-torrc
install -D -p -m 0644 %{SOURCE5}  %{buildroot}%{_tmpfilesdir}/tor.conf
...
%files
%doc README ChangeLog ReleaseNotes doc/HACKING doc/man/*.html
%license LICENSE
%{_bindir}/tor
%{_bindir}/tor-gencert
%{_bindir}/tor-resolve
