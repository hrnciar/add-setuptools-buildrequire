...
%if 0%{?fedora}
%setIMver 36 1:6.9.11.27
%setIMver 35 1:6.9.11.27
...
sed -i.skip spec/rmagick/image/changed_predicate_spec.rb \
	-e '\@still returns true after it has been persisted@s|it|xit|' \
	%{nil}
