...
Version:        2.6.8
Release:        2%{?dist}
# The entire source is GPLv3+, except src/Widgets/HeaderBarButton.vala, which
# is GPLv2+; and data/io.github.lainsce.Notejot.appdata.xml.in, which is CC0.
