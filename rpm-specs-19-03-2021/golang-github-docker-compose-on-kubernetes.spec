...
URL:            %{gourl}
Source0:        %{gosource}
# Adapt to k8s client-go v1.18+, using clientgofix
Patch0:         0001-Adapt-to-k8s-client-go-v1.18.patch
# Adapt to k8s.io/apimachinery/pkg/runtime v1.18+
Patch1:         https://github.com/docker/compose-on-kubernetes/pull/168.patch#/0001-Update-call-to-deprecated-K8s-function.patch
...
%changelog
* Tue Jan 26 2021 Fedora Release Engineering <releng@fedoraproject.org> - 0.5.0~alpha1-2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_34_Mass_Rebuild

* Sun Nov  8 2020 Olivier Lemasle <o.lemasle@gmail.com> - 0.5.0~alpha1-1
- Bump to 0.5.0-alpha1; unbundle dependencies
