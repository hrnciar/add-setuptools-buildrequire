...
%changelog
* Thu Mar 11 2021 Audrey Toskin <audrey@tosk.in> - 39-4
- Minor rebuild to mark Do Not Disturb Button 39 as incompatible with
  GNOME 40.

* Tue Jan 26 2021 Fedora Release Engineering <releng@fedoraproject.org> - 39-3
- Rebuilt for https://fedoraproject.org/wiki/Fedora_34_Mass_Rebuild

* Mon Jul 27 2020 Fedora Release Engineering <releng@fedoraproject.org> - 39-2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_33_Mass_Rebuild

* Tue Jun 23 2020 Audrey Toskin <audrey@tosk.in> - 39-1
- Bump to upstream version 39, which fixes a bug causing preferences not
  to appear at least on some distributions.

* Wed Apr 15 2020 Audrey Toskin <audrey@tosk.in> - 38-1
- Bump to upstream version 38, which changes how it launches the
  settings dialog.

* Tue Mar 31 2020 Audrey Toskin <audrey@tosk.in> - 36-1
- Bump to upstream version 36, which now requires GNOME 3.36+, and
  redesigns the preferences dialog.

* Thu Mar 19 2020 Audrey Toskin <audrey@tosk.in> - 35-1
