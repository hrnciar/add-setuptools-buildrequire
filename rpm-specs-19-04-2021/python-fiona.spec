...
# https://github.com/Toblerity/Fiona/pull/936
Patch0001:      0001-refactor-testdata_generator.patch
...
BuildRequires:  python3-click-plugins >= 1
...
EXTRA="and not _or_driver_error[DGN]"
%endif
# Skip debian tests since we are not on debian
%{pytest} -m "not network and not wheel" -k "not debian $EXTRA" -ra
