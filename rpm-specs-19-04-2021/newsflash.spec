...
# * bump gettext-rs dependency from 0.5.0 to 0.6.0:
#   https://gitlab.com/news-flash/news_flash_gtk/-/merge_requests/50
...
%changelog
* Fri Apr 02 2021 Fabio Valentini <decathorpe@gmail.com> - 1.3.0-2
- Bump gettext-rs dependency to 0.6.0
