# https://github.com/anonbeat/guayadeque/commit/79ec09daf908c37af413bff99312a08c06f43baf
%global commit0 79ec09daf908c37af413bff99312a08c06f43baf
%global shortcommit0 %(c=%{commit0}; echo ${c:0:7})
%global gitdate 20210415

Name:           guayadeque
Version:        0.4.7
Release:        0.30.%{gitdate}git%{shortcommit0}%{?dist}
