...
# Fix build with podofo-0.9.7, which introduced PdfObject automatic ownership handling
# See https://sourceforge.net/p/podofo/code/2000/
Patch1:         scribus_podofo.patch
