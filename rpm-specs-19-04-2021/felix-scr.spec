...
%mvn_build -f -- -Dfelix.java.version=8
...
%changelog
* Sat Mar 06 2021 Mat Booth <mat.booth@redhat.com> - 2.1.26-1
- Update to latest upstream release

* Tue Jan 26 2021 Fedora Release Engineering <releng@fedoraproject.org> - 2.1.16-8
