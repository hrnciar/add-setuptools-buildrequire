...
Patch0002: 0002-fix-remove-the-duplicated-StartupNotify-key-in-dde-o.patch

# fix: use Q_GLOBAL_STATIC to initialize eventHanlder and eventFilter
# Author: Robin Lee <cheeselee@fedoraproject.org>
Patch0003: 0003-fix-use-Q_GLOBAL_STATIC-to-initialize-eventHanlder-a.patch

# fix: use Q_GLOBAL_STATIC to initialise `urlToFileInfoMap`
# Author: Robin Lee <cheeselee@fedoraproject.org>
Patch0004: 0004-fix-use-Q_GLOBAL_STATIC-to-initialise-urlToFileInfoM.patch
