...
#		https://gitlab.cern.ch/hepmc/HepMC3/-/merge_requests/83
Patch0:		%{name}-fix-member-initialization-reordering-warnings.patch
Patch1:		%{name}-fix-sign-compare-and-dangling-else-warnings.patch
Patch2:		%{name}-fix-dereferencing-null-pointer-warning.patch
#		Fix build for multiple python versions (EPEL 7)
#		Fix from upstream git
Patch3:		%{name}-unset-python-executable-in-cmake-cache.patch
