...
VCS: git+ssh://git@pagure.io/rpkg-util.git#484b5cede0f1c8293359a5f07870655ec43d9e21:
%endif
...
%changelog
* Sat Feb 20 2021 clime <clime@fedoraproject.org> 2.10-1
- parse spec with _sourcedir set to self.path so that %%includes get
