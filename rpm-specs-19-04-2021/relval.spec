...
%changelog
* Thu Apr 08 2021 Adam Williamson <awilliam@redhat.com> - 2.5.4-1
- New release 2.5.4: size-check max sizes now from remote, not inline

* Wed Jan 27 2021 Fedora Release Engineering <releng@fedoraproject.org> - 2.5.3-2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_34_Mass_Rebuild

* Tue Dec 22 2020 Adam Williamson <awilliam@redhat.com> - 2.5.3-1
- New release 2.5.3: bump LXDE live size limit to 2GB
