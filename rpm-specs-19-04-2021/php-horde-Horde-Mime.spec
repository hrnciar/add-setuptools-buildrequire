...
BuildRequires: (php-pear(%{pear_channel}/Horde_Text_Filter) >= 2.0.0  with php-pear(%{pear_channel}/Horde_Text_Filter) < 3)
%else
BuildRequires:  php-pear(%{pear_channel}/Horde_Test)        >= 2.1.0
BuildRequires:  php-pear(%{pear_channel}/Horde_Support)     >= 2.1.0
BuildRequires:  php-pear(%{pear_channel}/Horde_Mail)        >= 2.5.0
BuildRequires:  php-pear(%{pear_channel}/Horde_Text_Filter) >= 2.0.0
%endif
%endif
...
%changelog
* Fri Feb  5 2021 Remi Collet <remi@remirepo.net> - 2.11.1-2
- add missing BuildRequires, Fix FTBFS #1923568
