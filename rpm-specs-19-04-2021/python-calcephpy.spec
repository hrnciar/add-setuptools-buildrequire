...
# The following patch has been made from modified sources provided by upstream
# maintainer in order to fix build with Python 3.10 on Fedora
Patch0:         calcephpy-3.4.7_py310.patch
