...
%files -n mingw32-python3-pyqt5-%{pkgname} -f mingw32-%{pkgname}.debugfiles
...
%files -n mingw64-python3-pyqt5-%{pkgname} -f mingw64-%{pkgname}.debugfiles
%{_prefix}/%{mingw64_target}/lib/python%{mingw32_python3_version}/site-packages/PyQt5*
%{mingw64_python3_sitearch}/PyQt5*


%changelog
* Tue Jan 26 2021 Fedora Release Engineering <releng@fedoraproject.org> - 4.19.24-3
- Rebuilt for https://fedoraproject.org/wiki/Fedora_34_Mass_Rebuild

* Wed Nov 04 2020 Sandro Mani <manisandro@gmail.com> - 4.19.24-2
- Also exclude debug files in pyqt5-sip subpackages
