...
# https://github.com/pynac/pynac/pull/362
...
# Temporary workaround for bz 1948438.  Remove this for pynac > 0.7.26.
...
sed -i 's/ -Wno-parentheses-equality//' ginac/Makefile.am

# Temporary workaround for bz 1948438.  Remove this for pynac > 0.7.26.
cp -p %{_datadir}/aclocal/ax_python_devel.m4 m4

# Regenerate configure due to the autoconf-archive update
autoreconf -fi .
...
%changelog
* Mon Apr 12 2021 Jerry James <loganjerry@gmail.com> - 0.7.26-7
- Refresh ax_python_devel.m4 from autoconf-archive (bz 1948438)
- Drop -python310 patch, included in the autoconf-archive version

* Wed Jan 27 2021 Fedora Release Engineering <releng@fedoraproject.org> - 0.7.26-6
- Rebuilt for https://fedoraproject.org/wiki/Fedora_34_Mass_Rebuild

* Wed Nov 18 2020 Jerry James <loganjerry@gmail.com> - 0.7.26-5
