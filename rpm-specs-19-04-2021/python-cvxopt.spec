...
# Fix a documentation cross reference
# https://github.com/cvxopt/cvxopt/pull/188
Patch1:         %{name}-doc.patch
# Fix mixed signed/unsigned operations
Patch2:         %{name}-signed.patch
# Add missing parentheses, causes FTBFS with python 3.10
# https://github.com/cvxopt/cvxopt/pull/190
Patch3:         %{name}-parens.patch
