...
Name:            %{name}
Version:         %{mainversion}
Release:         %{?beta_ver:0.}%{fedora_rel}%{?beta_ver:.%beta_ver}%{flagrel}%{?dist}%{?extrarel}
Epoch:           1
License:         MIT
...
Patch4601:       xscreensaver-6.00-0001-screensaver_id-search-parenthesis-first-for-searchin.patch
#
# gcc warning cleanup
