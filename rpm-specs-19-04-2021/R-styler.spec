...
# Depends:
# Imports:   R-backports >= 1.1.0, R-cli >= 1.1.0, R-magrittr >= 2.0.0, R-purrr >= 0.2.3, R-R.cache >= 0.14.0, R-rematch2 >= 2.0.1, R-rlang >= 0.1.1, R-rprojroot >= 1.1, R-tibble >= 1.4.2, R-tools, R-withr >= 1.0.0, R-xfun >= 0.1
...
# Remove unnecessary script used for CRAN upload.
rm -r %{buildroot}%{rlibdir}/%{packname}/hooks
