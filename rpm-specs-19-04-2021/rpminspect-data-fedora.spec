...
Source0:        https://github.com/rpminspect/rpminspect-data-fedora/releases/download/v1.4/rpminspect-data-fedora-1.4.tar.xz
Source1:        changelog
...
%prep
%setup -q -n rpminspect-data-fedora-1.4
