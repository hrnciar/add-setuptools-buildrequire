...
# Support RHEL
# https://github.com/cobbler/cobbler/pull/2438
Patch1:         cobbler-rhel.patch
# Give root write permissions to /var/lib/cobbler/web.ss
# https://github.com/cobbler/cobbler/pull/2439
Patch2:         0001-Give-root-RW-permissions-to-var-lib-cobbler-web.ss.patch
# Fix SELinux logging issue
Patch3:         https://patch-diff.githubusercontent.com/raw/cobbler/cobbler/pull/2441.patch
BuildArch:      noarch
