...
BuildRequires: (php-autoloader(%{gh_owner}/laminas-servicemanager)       >= 3.6.0  with php-autoloader(%{gh_owner}/laminas-servicemanager)       < 4)
...
Requires:      (php-autoloader(%{gh_owner}/laminas-servicemanager)       >= 3.6.0  with php-autoloader(%{gh_owner}/laminas-servicemanager)       < 4)
