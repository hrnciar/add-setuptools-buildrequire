...
# Fedora 34 (ruby 3.0)
# https://github.com/pdfkit/pdfkit/issues/485
# https://github.com/ruby/uri/issues/14
# https://github.com/pdfkit/pdfkit/pull/490
# e.g. https://github.com/middleman/middleman/commit/dead1c3f2a38535fa8a51b137fe19b56b8a3ff0a
Patch1:	rubygem-pdfkit-0.8.5-use-webrick.patch
...
%if 0%{?fedora} >= 34
%patch1 -p1
%gemspec_add_dep -g webrick -s %{gem_name}.gemspec
%endif
