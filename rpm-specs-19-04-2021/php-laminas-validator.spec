...
%global bootstrap    0
%global gh_commit    e370c4695db1c81e6dfad38d8c4dbdb37b23d776
...
BuildRequires: (php-autoloader(%{gh_owner}/laminas-http)                 >= 2.14.2 with php-autoloader(%{gh_owner}/laminas-http)                 < 3)
BuildRequires: (php-autoloader(%{gh_owner}/laminas-session)              >= 2.8   with php-autoloader(%{gh_owner}/laminas-session)              < 3)
BuildRequires: (php-autoloader(%{gh_owner}/laminas-uri)                  >= 2.7   with php-autoloader(%{gh_owner}/laminas-uri)                  < 3)
%endif
