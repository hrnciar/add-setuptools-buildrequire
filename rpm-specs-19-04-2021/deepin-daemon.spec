...
# fix(uadpagent): 错误了没有立即返回
# Author: electricface <songwentai@uniontech.com>
Patch0005: 0005-fix-uadpagent.patch

# fix(rpm): add missed requirements
# Author: Robin Lee <cheeselee@fedoraproject.org>
Patch0006: 0006-fix-rpm-add-missed-requirements.patch
...
%changelog
* Wed Apr 07 2021 Robin Lee <cheeselee@fedoraproject.org> - 5.12.52-2
