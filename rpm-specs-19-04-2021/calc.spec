...
# temporary -- this file appears to be installed by accident
# https://github.com/lcn2/calc/issues/28
chmod +w %{buildroot}%{_includedir}/calc/calcerr.c
rm %{buildroot}%{_includedir}/calc/calcerr.c
...
%changelog
* Fri Apr  9 2021 Matthew Miller <mattdm@fedoraproject.org> - 2.13.0.0-1
- update to new "unstable" upstream release.
- Includes incompatible change to "argv()" function

* Thu Mar  4 2021 Matthew Miller <mattdm@fedoraproject.org> - 2.12.8.2-1
...
* Tue Jan 26 2021 Fedora Release Engineering <releng@fedoraproject.org> - 2.12.7.2-7
