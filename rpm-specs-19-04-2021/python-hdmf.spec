...
# Have a few failures related to h5py
# Issue filed: https://github.com/hdmf-dev/hdmf/issues/563
%bcond_with tests
...
%changelog
* Sun Apr 11 2021 Ankur Sinha <ankursinha AT fedoraproject DOT org> - 2.4.0-2
- Add maintainer note
- Report failing tests upstream and add comment
