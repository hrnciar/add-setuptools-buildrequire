...
%build
./configure --user=couchdb --with-curl --erlang-md5 --spidermonkey-version 68 --skip-deps --rebar /usr/bin/rebar
...
%changelog
* Tue Mar 02 2021 Zbigniew Jędrzejewski-Szmek <zbyszek@in.waw.pl> - 3.1.1-4
- Rebuilt for updated systemd-rpm-macros
  See https://pagure.io/fesco/issue/2583.

* Sat Jan 30 2021 Frantisek Zatloukal <fzatlouk@redhat.com> - 3.1.1-3
- Switch to SpiderMonkey 68
