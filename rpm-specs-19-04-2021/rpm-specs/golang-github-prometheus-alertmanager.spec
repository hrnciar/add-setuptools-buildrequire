...
# Patch to use newer common
Patch1:         0001-Update-common.patch
...
* Mon Dec 21 11:26:23 CET 2020 Robert-André Mauchin <zebob.m@gmail.com> - 0.21.0-2
- Add patch to use newer common.
- Fix FTBFS
