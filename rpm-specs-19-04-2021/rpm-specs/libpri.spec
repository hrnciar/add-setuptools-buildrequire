...
- Add ldconfig_scriptlets macro for EPEL7 only

* Tue Jan 26 2021 Fedora Release Engineering <releng@fedoraproject.org> - 1.6.0-12
- Rebuilt for https://fedoraproject.org/wiki/Fedora_34_Mass_Rebuild

* Sat Dec  5 2020 Benjamin A. Beasley <code@musicinmybrain.net> - 1.6.0-11
- Trivial typo fix in description

* Fri Dec  4 2020 Benjamin A. Beasley <code@musicinmybrain.net> - 1.6.0-10
