...
# https://github.com/Apipie/apipie-rails/pull/684
Patch0: apipie-rails-0.5.18-Fix-Ruby-2.7-keyword-arguments-deprecation-warnings.patch
...
# Rails 4 compat code causes issues with Ruby 3.0 compatibility, but we are
# testing agains Rails 6+ anyway, so just disable the moneky patch.
# https://github.com/Apipie/apipie-rails/issues/705
sed -i '/:prepend.*Rails4Compatibility::Testing/ s/^/#/' spec/spec_helper.rb
