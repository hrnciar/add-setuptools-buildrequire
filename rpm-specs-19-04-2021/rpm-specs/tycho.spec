...
%changelog
* Thu Apr 8 2021 Alexander Kurtakov <akurtako@redhat.com> 2.3.0-1
- Update to upstream 2.3.0 release.

* Mon Feb  8 2021 Mat Booth <mat.booth@redhat.com> - 2.2.0-4
- Fix eln build

* Mon Feb  8 2021 Mat Booth <mat.booth@redhat.com> - 2.2.0-3
- Accomodate for API change in surefire 3.0.0~M4

* Thu Feb  4 2021 Mat Booth <mat.booth@redhat.com> - 2.2.0-2
- Add missing runtime dep on aqute-bnd

* Tue Feb  2 2021 Mat Booth <mat.booth@redhat.com> - 2.2.0-1
- Update to latest upstream release
- Update bootstrap Eclipse version

* Tue Feb  2 2021 Mat Booth <mat.booth@redhat.com> - 2.1.0-5
- Debootstrap build

* Wed Jan 27 2021 Fedora Release Engineering <releng@fedoraproject.org> - 2.1.0-4
- Rebuilt for https://fedoraproject.org/wiki/Fedora_34_Mass_Rebuild

* Thu Jan 14 2021 Mat Booth <mat.booth@redhat.com> - 2.1.0-3
- Enable bootstrap mode
- Update fp-p2 snapshot to fix xmvn installation failure

* Thu Jan 14 2021 Mat Booth <mat.booth@redhat.com> - 2.1.0-2
- Fix embedded equinox location discovery and fix bootstrapping on Java 11

* Tue Nov 24 2020 Mat Booth <mat.booth@redhat.com> - 2.1.0-1
- Update to latest upstream release

* Wed Nov 11 2020 Mat Booth <mat.booth@redhat.com> - 1.7.0-4
- Debootstrap build

* Wed Nov 11 2020 Mat Booth <mat.booth@redhat.com> - 1.7.0-3
- Add deps needed for bootstrapping

* Wed Nov 11 2020 Mat Booth <mat.booth@redhat.com> - 1.7.0-2
- Bootstrap against Eclipse 4.17

* Wed Nov 11 2020 Mat Booth <mat.booth@redhat.com> - 1.7.0-1
