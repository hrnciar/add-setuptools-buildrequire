...
# * No Mac deps
# * Drop optional dependency on signal (not packaged)
...
%package     -n %{name}+renamed_serde-devel
Summary:        %{summary}
BuildArch:      noarch

%description -n %{name}+renamed_serde-devel %{_description}

This package contains library source intended for building other packages
which use "renamed_serde" feature of "%{crate}" crate.

%files       -n %{name}+renamed_serde-devel
%ghost %{cargo_registry}/%{crate}-%{version_no_tilde}/Cargo.toml
...
* Sat Dec 12 2020 Fabio Valentini <decathorpe@gmail.com> - 3.2.0-2
- Remove features with missing dependencies (signal).

* Sun Oct 25 2020 Fabio Valentini <decathorpe@gmail.com> - 3.2.0-1
...
* Wed Mar 18 2020 Artem Polishchuk <ego.cordatus@gmail.com> - 3.0.1-1
- Initial package
