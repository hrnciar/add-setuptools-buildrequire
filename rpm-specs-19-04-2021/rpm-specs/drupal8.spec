...
%global pear_archive_tar_min_ver 1.4.11
...
%endif
# phpcompatinfo (computed from version 8.9.11)
Requires:  php-ctype
Requires:  php-curl
Requires:  php-ftp
Requires:  php-iconv
...
Provides:  drupal8(comment_base_field_test) = %{version}
...
Provides:  drupal8(media_library_form_overwrite_test) = %{version}
...
Provides:  drupal8(views_config_entity_test) = %{version}
...
%changelog
* Tue Jan 26 2021 Fedora Release Engineering <releng@fedoraproject.org> - 8.9.11-2
