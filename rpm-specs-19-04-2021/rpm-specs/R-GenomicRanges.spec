...
BuildRequires:    R-devel tex(latex) R-core >= 3.4.0 R-methods R-stats4 R-utils R-stats
BuildRequires:    R-IRanges-devel >= 2.23.9 R-BiocGenerics >= 0.25.3 R-XVector-devel >= 0.29.2 R-GenomeInfoDb >= 1.15.2 R-S4Vectors-devel >= 0.27.12
