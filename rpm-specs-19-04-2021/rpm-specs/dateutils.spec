...
%changelog
* Thu Mar  4 2021 Matthew Miller <mattdm@fedoraproject.org> - 0.4.8-1
- upstream bugfix and security release:
...
- drop build patch now released upstream

* Tue Jan 26 2021 Fedora Release Engineering <releng@fedoraproject.org> - 0.4.7-4
