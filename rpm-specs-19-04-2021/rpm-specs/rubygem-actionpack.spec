...
# cd rails/actionpack && git archive -v -o actionpack-6.1.3.1-tests.txz v6.1.3.1 test/
...
# Test failures: browsersName is no longer mentioned in capabilities
# https://github.com/rails/rails/issues/41287
