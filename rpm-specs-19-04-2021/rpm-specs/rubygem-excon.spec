...
# cd excon && git archive -v -o excon-0.79.0-tests.txz v0.79.0 tests/ spec/
Source1: %{gem_name}-%{version}-tests.txz
# Fix test suite hangs due to failing startup of test rack server.
# https://github.com/excon/excon/pull/735
Patch0: rubygem-excon-0.79.0-Do-not-use-explicit-hash-for-options.patch
