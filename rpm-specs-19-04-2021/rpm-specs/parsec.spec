...
%global __cargo_parse_opts --features=mbed-crypto-provider,pkcs11-provider,tpm-provider,all-authenticators
...
Patch0:        parsec-fix-metadata.diff
...
%build
%custom_cargo_build --features=mbed-crypto-provider,pkcs11-provider,tpm-provider,all-authenticators
