...
BuildRequires:    R-devel >= 3.4.0, tetex-latex, R-methods, R-stats4, R-stats
BuildRequires:    R-BiocGenerics >= 0.31.5, R-MatrixGenerics >= 1.1.3, R-S4Vectors-devel >= 0.27.2, R-IRanges-devel >= 2.17.3
