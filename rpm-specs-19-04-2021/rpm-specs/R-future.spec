...
# Depends:
# Imports:   R-digest, R-globals >= 0.13.1, R-listenv >= 0.8.0, R-parallel, R-parallelly >= 1.21.0, R-tools, R-utils
...
BuildRequires:    R-globals >= 0.13.1
BuildRequires:    R-listenv >= 0.8.0
BuildRequires:    R-parallel
BuildRequires:    R-parallelly >= 1.21.0
...
%changelog
* Mon Jan 25 2021 Fedora Release Engineering <releng@fedoraproject.org> - 1.21.0-2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_34_Mass_Rebuild

* Sat Dec 12 2020 Elliott Sales de Andrade <quantum.analyst@gmail.com> - 1.21.0-1
- Update to latest version (#1893975)
