# Temporarily disabled, filed as rhbz#1932204
ExcludeArch: ppc64le 
...
Name: icecat
Version: 78.9.0
Release: 3%{extra_ver}.%{redhat_ver}%{?pre_tag}%{?dist}
...
Patch424: %{name}-mozilla-1669471.patch
Patch425: mozilla-1692706.patch
Patch426: %{name}-mozilla-1613672.patch
...
Provides: webclient
Provides: bundled(mozilla-https-everywhere) = 2021.1.27
...
%patch423 -p1 -b .1596503
%patch424 -p1 -b .1669471
%patch425 -p1 -b .1692706
%patch426 -p1 -b .1613672
...
- Patched for Mozilla bug #1613672
- Use cbindgen 0.18.0
- Debug build on
