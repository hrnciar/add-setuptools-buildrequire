...
Patch0002: 0002-virtcontainers-Don-t-set-Ctty.patch
...
# Temporarily enforce cgroupsv1 inside the guest
sed -i -e 's/^kernel_params = ""/kernel_params = "systemd.unified_cgroup_hierarchy=0"/' %{buildroot}%{_datadir}/kata-containers/defaults/configuration.toml
...
%changelog
* Mon Mar 01 2021 Eduardo Lima (Etrunko) <etrunko@redhat.com> - 1.12.1-2
- Provides: oci-runtime

* Thu Feb 25 2021 Eduardo Lima (Etrunko) <etrunko@redhat.com> - 1.12.1-1
- Update to version 1.12.1

* Tue Jan 26 2021 Fedora Release Engineering <releng@fedoraproject.org> - 1.12.0-2.1
- Rebuilt for https://fedoraproject.org/wiki/Fedora_34_Mass_Rebuild

* Fri Nov 20 2020 Fabiano Fidêncio <fidencio@redhat.com> - 1.12.0-2
- Don't set Ctty when building withgolang 15.2 onwards.
- Temporarily use cgroupsv1 inside the guest.
...
* Fri Oct 9 2020 Fabiano Fidêncio <fidencio@redhat.com> - 1.11.1-3
