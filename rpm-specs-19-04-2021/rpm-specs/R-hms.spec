...
# Depends:
# Imports:   R-ellipsis, R-lifecycle, R-methods, R-pkgconfig, R-rlang, R-vctrs >= 0.2.1
...
- Update to latest version (#1915983)

* Mon Jan 25 2021 Fedora Release Engineering <releng@fedoraproject.org> - 0.5.3-5
