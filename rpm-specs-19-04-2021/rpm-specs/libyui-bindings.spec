...
# Reported: https://github.com/libyui/libyui-bindings/pull/38
Patch0501:      libyui-bindings-2.0.2-ruby30.patch
...
* Thu Jan  7 2021 Mamoru TASAKA <mtasaka@fedoraproject.org> - 2.0.2-2
- F-34: rebuild with ruby 3.0
- Fix build error with ruby 3.0, reported upstream
