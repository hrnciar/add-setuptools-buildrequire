...
%configure CC=gcc CXX=g++ F77=gfortran CFLAGS="%{build_cflags}" CXXFLAGS="%{build_cxxflags}" \
...
%{_openmpi_load}
CFLAGS="%{build_cxxflags}"
OPT_CFLAGS="%{build_cflags}"
...
%configure --with-mumps-cflags="-I%{_includedir}/MUMPS -I$MPI_INCLUDE" \
