...
%{include_req_spec %{SOURCE1} Recommends}
# Additional packages required to build with even more dependencies,
# most notably with ROS and OpenRAVE support.
Recommends:       ccache, cmake, hostname
Recommends:       git, gitk, screen
Recommends:       python3-pyyaml, libxml2-devel, python3-libxml2
Recommends:       poco-devel, bzip2-devel, tbb-devel, log4cxx-devel
Recommends:       python3-setuptools, python3-numpy, python3-pyopengl, python3-collada, python3-empy
Recommends:       python3-sip-devel, python3-netifaces
Recommends:       compat-lua, clips-emacs
Recommends:       libmodbus-devel
Recommends:       qt-devel, fltk-devel
%if %{with mongodb}
Recommends:       mongodb-server
%endif
%if %{with ros}
Recommends:       ros-release, python3-rospkg, console-bridge-devel
Recommends:       rospack, rospack-devel, python3-rosdistro, python3-rosinstall
Recommends:       python3-rosinstall_generator, python3-wstool, python3-rosdep, python3-rosdistro
%endif
Recommends:       python-qt5-devel, python3-qt5-devel, python3-defusedxml
%if 0%{?have_openni} >= 1
Recommends:       openni-primesense
%endif
...
%changelog
* Fri Feb 12 2021 Tom Callaway <spot@fedoraproject.org> - 1.3.1-0.10.4923a6c
- rebuild for new bullet (and new gazebo built against new bullet)

* Tue Jan 26 2021 Fedora Release Engineering <releng@fedoraproject.org> - 1.3.1-0.9.4923a6c
- Rebuilt for https://fedoraproject.org/wiki/Fedora_34_Mass_Rebuild

* Fri Jan 22 2021 Jonathan Wakely <jwakely@redhat.com> - 1.3.1-0.8.4923a6c
- Rebuilt for Boost 1.75

* Sun Jan 17 2021 Mamoru TASAKA <mtasaka@fedoraproject.org> - 1.3.1-0.7.4923a6c
- rebuild against new protobuf

* Sat Dec 19 11:09:50 CET 2020 Till Hofmann <thofmann@fedoraproject.org> - 1.3.1-0.6.4923a6c
- Rebuild for librealsense-2.40

* Sat Oct 31 2020 Till Hofmann <thofmann@fedoraproject.org> - 1.3.1-0.5.4923a6c
- Remove dependency on emacs-lua
- Switch Requires to Recommends in devenv sub-package

* Sun Oct 25 2020 Till Hofmann <thofmann@fedoraproject.org> - 1.3.1-0.4.4923a6c
- Rebuilt for librealsense 2.39

* Thu Oct 22 2020 Nicolas Chauvet <kwizart@gmail.com> - 1.3.1-0.3.4923a6c
- Rebuilt for OpenCV
