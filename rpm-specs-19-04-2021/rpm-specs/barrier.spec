...
%prep
%setup -q
## ext/gtest and ext/gmock does not seems to contain *.cc
## thus remove test
rm -fr src/test
sed -i.remove-test -e 's/\(add_subdirectory(test)\)/# \1/' src/CMakeLists.txt
...
<component type="desktop-application">
  ...
  <releases>
    <release version="%{version}" date="2020-10-30" />
  </releases>
</component>
END
