...
# Revert IDXGIFactory6 and IDXGIFactory7 changes as those need new mingw
Patch01:         0001-Revert-IDXGIFactory6-IDXGIFactory7-changes.patch
...
%if 0%{?fedora} < 34
# Revert changes that require mingw >= 8.0 for Fedora < 34
%patch01 -p1
%endif
