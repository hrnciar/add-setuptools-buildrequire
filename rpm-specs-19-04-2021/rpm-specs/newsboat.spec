...
%changelog
* Mon Apr 12 2021 Jan Staněk <jstanek@redhat.com> - 2.23-2
- Do not use git for patch application
  It messes up the version number reporting in the app.

* Mon Mar 22 2021 Jan Staněk <jstanek@redhat.com> - 2.23-1
