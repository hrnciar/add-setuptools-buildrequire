...
Source0: https://download.wikimedia.org/mediawiki/1.35/%{name}-%{version}.tar.gz
Source1: https://download.wikimedia.org/mediawiki/1.35/%{name}-%{version}.tar.gz.sig
...
Provides: bundled(php-wikimedia-parsoid) = 0.12.2
