...
%package     -n %{name}+reduced-stack-buffer-devel
Summary:        %{summary}
BuildArch:      noarch

%description -n %{name}+reduced-stack-buffer-devel %{_description}

This package contains library source intended for building other packages
which use "reduced-stack-buffer" feature of "%{crate}" crate.

%files       -n %{name}+reduced-stack-buffer-devel
%ghost %{cargo_registry}/%{crate}-%{version_no_tilde}/Cargo.toml
...
%changelog
* Fri Mar 26 2021 Fabio Valentini <decathorpe@gmail.com> - 0.42.2-1
- Update to version 0.42.2.
- Fixes RHBZ#1936997

* Wed Jan 27 2021 Fedora Release Engineering <releng@fedoraproject.org> - 0.42.1-2
