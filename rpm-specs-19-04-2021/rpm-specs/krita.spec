...
Source0:        http://download.kde.org/%{?pre:un}stable/krita/%{versiondir}%{?pre:-%{pre}}/krita-%{version}%{?pre:-%{pre}}.tar.xz

## downstream patches

## upstream patches
Patch6: 0006-Fix-crash-on-popup-palette-on-125-scale.patch
Patch8: 0008-Fix-compilation-for-GCC11.patch
