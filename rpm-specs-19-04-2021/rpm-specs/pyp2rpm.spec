...
# TestVirtualEnvGetData and TestPypiDownloader are broken in the 3.3.6 release. Temporarily disable them.
PYTHONPATH="." py.test-3 -vv -m "not webtest" -k "not TestMetadataExtractor and not TestVirtualEnvGetData and not TestPypiDownloader"
