...
BuildRequires: (php-pear(%{pear_channel}/Horde_Secret)      >= 2.0.0  with php-pear(%{pear_channel}/Horde_Secret)      < 3)
%else
...
BuildRequires:  php-pear(%{pear_channel}/Horde_Secret) >= 2.0.0
%endif
...
%changelog
* Mon Feb 15 2021 Remi Collet <remi@remirepo.net> - 2.3.7-1
- update to 2.3.7
- add dependency on Horde_Secret

* Wed Jan 27 2021 Fedora Release Engineering <releng@fedoraproject.org> - 2.3.6-6
