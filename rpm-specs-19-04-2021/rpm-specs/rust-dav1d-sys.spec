...
# * Bump bindgen to 0.57 (patched in main)
# * Downgrade system-deps to 1.3.0 (it requires dozens of packages to be updated to 3.0)
Patch0:         dav1d-sys-fix-metadata.diff
