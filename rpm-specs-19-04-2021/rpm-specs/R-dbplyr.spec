...
# Depends:
# Imports:   R-assertthat >= 0.2.0, R-blob >= 1.2.0, R-DBI >= 1.0.0, R-dplyr >= 1.0.4, R-ellipsis, R-glue >= 1.2.0, R-lifecycle >= 1.0.0, R-magrittr, R-methods, R-purrr >= 0.2.5, R-R6 >= 2.2.2, R-rlang >= 0.2.0, R-tibble >= 1.4.2, R-tidyselect >= 0.2.4, R-utils, R-vctrs, R-withr
# Suggests:  R-bit64, R-covr, R-knitr, R-Lahman, R-nycflights13, R-odbc, R-RMariaDB >= 1.0.2, R-rmarkdown, R-RPostgres >= 1.1.3, R-RPostgreSQL, R-RSQLite >= 2.1.0, R-testthat >= 3.0.2, R-tidyr
# LinkingTo:
# Enhances:
