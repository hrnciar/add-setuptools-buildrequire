...
Source0:        https://download.qt.io/%{?prerelease:development}%{?!prerelease:official}_releases/qtcreator/4.15/%{version}%{?prerelease:-%prerelease}/qt-creator-opensource-src-%{version}%{?prerelease:-%prerelease}.tar.xz
...
# Fix linking issues
Patch5:         qt-creator_linklibs.patch
%if 0%{fedora} >= 34
# Fix build against clang-12
Patch6:         qt-creator_clang12.patch
%endif
# Fix build
Patch7:         qt-creator_build.patch
...
appstream-util validate-relax --nonet %{buildroot}%{_datadir}/metainfo/org.qt-project.qtcreator.appdata.xml
