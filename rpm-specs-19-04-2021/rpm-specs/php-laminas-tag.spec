...
#
%global bootstrap    0
%global gh_commit    f8d754c800196375869b7a4fae870ca89ab91bfb
...
#        "phpunit/phpunit": "^9.3"
BuildRequires: (php-autoloader(%{gh_owner}/laminas-escaper)              >= 2.7   with php-autoloader(%{gh_owner}/laminas-escaper)              < 3)
...
Requires:      (php-autoloader(%{gh_owner}/laminas-escaper)              >= 2.7   with php-autoloader(%{gh_owner}/laminas-escaper)              < 3)
