...
%changelog
%changelog
* Wed Jan 27 2021 Fedora Release Monitoring <release-monitoring@fedoraproject.org> - 3.12.2-1
- Update to 3.12.2 (#1920141)

* Tue Jan 26 2021 Fedora Release Engineering <releng@fedoraproject.org> - 3.12.1-3
- Rebuilt for https://fedoraproject.org/wiki/Fedora_34_Mass_Rebuild

* Sat Dec 19 2020 Luya Tshimbalanga <luya@fedoraproject.org> - 3.12.1-2
- Rebuild for ispc 1.5.0

* Wed Oct 14 2020 Fedora Release Monitoring <release-monitoring@fedoraproject.org> - 3.12.1-1
- Update to 3.12.1 (#1880382)
- Set Max ISA detection to default
- Drop support for EOL Fedora 31

* Wed Sep 23 2020 Fedora Release Monitoring <release-monitoring@fedoraproject.org> - 3.12.0-1
- Update to 3.12.0 (#1880382)
