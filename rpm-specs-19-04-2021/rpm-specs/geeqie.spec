...
%global gitcommit 737a3dc19275ac11d8a6225dbd03639e73b22fee
...
Patch0: geeqie-1.6-docbuildfix.patch
...
# Clutter support doesn't seem to work, images are not displayed.
...
%changelog
* Thu Apr  8 2021 Matthew Miller <mattdm@mattdm.org> - 1.6-4.git737a3dc
- remove the docs conditional

* Thu Apr  8 2021 Matthew Miller <mattdm@mattdm.org> - 1.6-3.git737a3dc
- update to 737a3dc19275ac11d8a6225dbd03639e73b22fee to fix on F34
- when building docs, ignore missing media files (we copy them later)
  and also use "html/" as the output directory instead of "html", because
  OF COURSE that's the problem. https://github.com/BestImageViewer/geeqie/pull/882

* Tue Jan 26 2021 Fedora Release Engineering <releng@fedoraproject.org> - 1.6-2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_34_Mass_Rebuild

* Thu Dec 17 2020 Zbigniew Jędrzejewski-Szmek <zbyszek@in.waw.pl> - 1.6-1
- Latest version (#1903787)
- Switch from gtk2 to gtk3
- Support webp images and pdf files
