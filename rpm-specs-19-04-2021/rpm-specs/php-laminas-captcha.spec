...
#
%global bootstrap    0
%global gh_commit    9a0134e434cd792934ecca42cb66f316be7bba50
...
BuildRequires: (php-autoloader(%{gh_owner}/laminas-session)              >= 2.10    with php-autoloader(%{gh_owner}/laminas-session)              < 3)
BuildRequires: (php-autoloader(%{gh_owner}/laminas-text)                 >= 2.8     with php-autoloader(%{gh_owner}/laminas-text)                 < 3)
BuildRequires: (php-autoloader(%{gh_owner}/laminas-validator)            >= 2.14    with php-autoloader(%{gh_owner}/laminas-validator)            < 3)
%global phpunit %{_bindir}/phpunit9
BuildRequires:  phpunit9 >= 9.4.3
%endif
# Autoloader
