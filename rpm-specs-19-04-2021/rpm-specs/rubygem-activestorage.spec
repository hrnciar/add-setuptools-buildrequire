...
# cd rails/activestorage && git archive -v -o activestorage-6.1.3.1-tests.txz v6.1.3.1 test/
...
# We have older version in Fedora, but upstream also supports new one.
# https://github.com/rails/rails/commit/b80a2bdeb955c81649e483f2f020a3d5f407c2f9
%gemspec_remove_dep -g mini_mime "~> 1.0.2"
%gemspec_add_dep -g mini_mime ">= 1.0.0"
