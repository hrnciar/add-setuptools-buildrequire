...
%global github_commit   0e542b64451a0cd95095b78d36dac5fc5419f5b0
# if set, will be a post-release snapshot build, otherwise a 'normal' build
%global github_date     20210401
...
# Diff from SUSE: we have 'sqlite' not 'sqlite3'
# The following line is generated from dependencies.yaml (upstream)
%define worker_requires openqa-client optipng os-autoinst < 5 perl(File::Map) perl(Minion::Backend::SQLite) >= 5.0.1 perl(Mojo::IOLoop::ReadWriteProcess) >= 0.26 perl(Mojo::SQLite) psmisc sqlite >= 3.24.0
# The following line is generated from dependencies.yaml (upstream)
...
Release:        62%{?github_date:.%{github_date}git%{shortcommit}}%{?dist}
...
# Fix request routing for Mojolicious 9.11 security improvements
# https://github.com/os-autoinst/openQA/pull/3816
Patch1:         0001-Fix-several-more-API-routes-for-Mojolicious-9.11-rou.patch
