...
%{_datadir}/%{name}/
%{_qt5_plugindir}/designer/libdrumstick-vpiano-plugin.so
...
%changelog
* Wed Mar 31 2021 Fedora Release Monitoring <release-monitoring@fedoraproject.org> - 2.1.1-1
- Update to 2.1.1 (#1944929)

* Sun Mar 21 2021 Qiyu Yan <yanqiyu@fedoraproject.org> - 2.1.0-1
- Update to 2.1.0 upstream release

* Tue Jan 26 2021 Fedora Release Engineering <releng@fedoraproject.org> - 2.0.0-2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_34_Mass_Rebuild

* Sun Jan 10 2021 Robin Lee <cheeselee@fedoraproject.org> - 2.0.0-1
- Update to 2.0.0
