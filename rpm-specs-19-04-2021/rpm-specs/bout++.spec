...
%changelog
* Fri Mar 19 2021 David Schwörer <davidsch@fedoraproject.org> 4.3.2-7
- Rebuild for sundials 5.7.0

* Sat Feb 06 2021 David Schwörer <davidsch@fedoraproject.org> 4.3.2-6
...
* Sun Jan 17 2021 David Schwörer <davidsch@fedoraproject.org> 4.3.2-4
- Increase timeout for tests RHBZ#1914777

* Wed Jan 06 2021 Orion Poplawski <orion@nwra.com> - 4.3.2-3
- Rebuild for sundials 5.6.1

* Sun Nov 22 2020 David Schwörer <davidsch@fedoraproject.org> 4.3.2-2
- Rebuild for sundials 5.5.0 and petsc 3.14.1

* Wed Oct 21 2020 David Schwörer <davidsch@fedoraproject.org> 4.3.2-1
- Update to 4.3.2
- add python provides
