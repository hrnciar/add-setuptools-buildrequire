...
# Fix the keyword arguments on Ruby 3.0.
# https://github.com/steveklabnik/mono_logger/pull/8
sed -i '/Logger::LogDevice.new/ s/log, opt/log, **opt/' test/mri_logger_test.rb
...
%changelog
* Wed Mar 03 2021 Jun Aruga <jaruga@redhat.com> - 1.1.0-16
- Fix the keyword arguments on Ruby 3.0.
  Resolves: rhbz#1923367
