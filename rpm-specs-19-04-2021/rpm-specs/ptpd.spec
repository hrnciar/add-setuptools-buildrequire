...
Name:    ptpd
Version: 2.3.1
Release: 20%{?gitshort:.%{gitshort}}%{?dist}
...
%changelog
* Tue Mar 02 2021 Zbigniew Jędrzejewski-Szmek <zbyszek@in.waw.pl> - 2.3.1-20.235e9b4
- Rebuilt for updated systemd-rpm-macros
  See https://pagure.io/fesco/issue/2583.

* Wed Jan 27 2021 Fedora Release Engineering <releng@fedoraproject.org> - 2.3.1-19.235e9b4
