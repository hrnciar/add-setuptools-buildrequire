...
# GCC can sometimes replace the entire test with direct failure due to
# detecting division by zero.  Skip this test until we can figure out how
# make GCC be a little less clever.
Patch10:        %{name}-div-by-zero.patch
...
# FIXME: there is some kind of problem on s390x involving Java mutexes.
# It almost looks like they are nonatomic.  Disable s390x tests until we
