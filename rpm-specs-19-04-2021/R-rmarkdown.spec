...
# Depends:
# Imports:   R-tools, R-utils, R-knitr >= 1.22, R-yaml >= 2.1.19, R-htmltools >= 0.3.5, R-evaluate >= 0.13, R-jsonlite, R-tinytex >= 0.11, R-xfun >= 0.15, R-methods, R-stringr >= 1.2.0
# Suggests:  R-shiny >= 0.11, R-tufte, R-testthat >= 2.0.0, R-digest, R-dygraphs, R-vctrs, R-tibble, R-fs, R-rsconnect, R-withr >= 2.3.0
# LinkingTo:
# Enhances:
...
%changelog
* Mon Jan 25 2021 Fedora Release Engineering <releng@fedoraproject.org> - 2.6-2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_34_Mass_Rebuild

* Wed Dec 23 2020 Elliott Sales de Andrade <quantum.analyst@gmail.com> - 2.6-1
- Update to latest version (#1907599)

* Mon Oct 26 2020 Elliott Sales de Andrade <quantum.analyst@gmail.com> - 2.5-1
- Update to latest version (#1890003)
