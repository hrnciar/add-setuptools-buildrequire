...
Patch7: eclipse-feature-plugins-to-category-ius.patch

Patch8: eclipse-support-symlink-bundles.patch

# Droplet fixes
Patch9: eclipse-pde-tp-support-droplets.patch

# Disable uses by default
Patch10: eclipse-disable-uses-constraints.patch

# Droplet fixes
Patch11: eclipse-make-droplets-runnable.patch
Patch12: eclipse-disable-droplets-in-dropins.patch

# Fix errors when building ant launcher
Patch13: fix_ant_build.patch

# Hide the p2 Droplets from cluttering Install Wizard Combo
Patch14: eclipse-hide-droplets-from-install-wizard.patch

# Avoid the need for a javascript interpreter at build time
Patch15: eclipse-swt-avoid-javascript-at-build.patch

# Avoid optional dep used only for tests
Patch16: eclipse-patch-out-fileupload-dep.patch

# Force a clean on the restart after p2 operations
Patch17: force-clean-after-p2-operations.patch
...
%pom_disable_module org.eclipse.jdt.ui.examples.projects eclipse.jdt.ui
%pom_disable_module org.eclipse.jdt.ui.junit.sampleproject eclipse.jdt.ui
...
# Bundles requires a Java 1.8 feature
...
%changelog
* Thu Apr 8 2021 Alexander Kurtakov <akurtako@redhat.com> 1:4.19-4
- No longer prefer x11
- Remove test patches as tests are no longer executed
- Organize patches
- Remove useless BRs
...
* Fri Jan 15 2021 Mat Booth <mat.booth@redhat.com> - 1:4.18-1
