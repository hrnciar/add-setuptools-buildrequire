...
# git archive -v -o redis-rb-4.2.5-tests.txz v4.2.5 makefile test/ bin/
Source1: %{gem_name}-rb-%{version}-tests.txz
# Fix Redis 6.2+ test failures.
# https://github.com/redis/redis-rb/pull/979
Patch0: rubygem-redis-4.2.5-Add-Redis-6.2-support.patch
BuildRequires: make
