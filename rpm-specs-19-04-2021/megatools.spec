...
Source0:        http://megatools.megous.com/builds/experimental/%{name}-%{version}-%{snapshot}.tar.gz
Source1:        http://megatools.megous.com/builds/experimental/%{name}-%{version}-%{snapshot}.tar.gz.asc
