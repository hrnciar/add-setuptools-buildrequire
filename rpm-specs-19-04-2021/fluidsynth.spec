...
make doxygen -C doc
# fix rhbrz #1921265
sed -i '/navelem/d' doc/api/html/version_8h.html
%else
%if 0%{?el8}
make doxygen -C doc
# fix rhbrz #1921265
...
# fix rhbrz #1921265
sed -i '/navelem/d' %{_target_platform}/doc/api/html/version_8h.html
%endif
%endif
...
%doc doc/api/html
%else
%doc %{_target_platform}/doc/api/html
%endif
%endif
%doc doc/*.c doc/*fluid*.txt doc/*.odt
%doc ChangeLog
