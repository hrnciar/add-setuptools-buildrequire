...
%package     -n %{name}+actix-reexport-devel
Summary:        %{summary}
BuildArch:      noarch

%description -n %{name}+actix-reexport-devel %{_description}

This package contains library source intended for building other packages
which use "actix-reexport" feature of "%{crate}" crate.

%files       -n %{name}+actix-reexport-devel
%ghost %{cargo_registry}/%{crate}-%{version_no_tilde}/Cargo.toml
