...
%global commit 23718a890dee78e619521421237bb3985dcb61a5
...
License:        GPLv3
URL:            %{forgeurl}
Source0:        %{url}/archive/%{commit}/argos-%{commit}.tar.gz

# Add GNOME 3.38 and 40 compatibility
Patch0:         %{url}/pull/2.patch#/argos-gnome40.patch
...
%changelog
* Wed Mar 31 2021 Michel Alexandre Salim <salimma@fedoraproject.org> - 3-6.20200505git23718a8
- Stop using forge macros as they are buggy on EPEL8

* Fri Mar 26 2021 Michel Alexandre Salim <salimma@fedoraproject.org> - 3-5.20200505git23718a8
- Switch to mwilck's fork which has better support for newer GNOME versions
- Declare support for GNOME 3.38 and 40

* Tue Jan 26 2021 Fedora Release Engineering <releng@fedoraproject.org> - 3-4.20200110.fcb4751
