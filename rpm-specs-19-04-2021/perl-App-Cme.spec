...
# Adapt to Getopt-Long-Descriptive-0.106, bug #1938396, proposed to the
# upstream, <https://github.com/dod38fr/cme-perl/issues/5>
Patch0:         App-Cme-1.032-Do-not-specify-options-multiple-times.patch
BuildArch:      noarch
